...
| The module's *shape* is the problem: where the seam goes, how deep the interface is | [codebase-design](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/codebase-design.md) |
| You want the whole plan interrogated before you build | [grill-with-docs](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/grill-with-docs.md), which drives this skill underneath |
...
`domain-modeling` is a **model-invoked reference** that runs *underneath* other skills more often than it runs on its own. [grill-with-docs](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/grill-with-docs.md) drives it through a grilling session, [wayfinder](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/wayfinder.md) loads it while charting a map, [triage](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/triage.md) uses it to keep [tickets](https://www.aihero.dev/ai-coding-dictionary/ticket) in the project's own words, and [improve-codebase-architecture](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/improve-codebase-architecture.md) calls it as decisions crystallise. Its closest sibling is [codebase-design](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/codebase-design.md): the two are the vocabulary layer under everything else, this one for the *domain*, that one for the module's *shape*. It is also reachable directly, when you want the discipline without committing to the steps of whatever skill would normally pull it in. When you are unsure which skill fits, [ask-itech-skills](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/ask-itech-skills.md) routes you.
