...
| The *words of the domain*: "account" means three things, two people mean different things by "cancellation" | [domain-modeling](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/domain-modeling.md) |
| You don't yet know *which* module to redesign | [improve-codebase-architecture](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/improve-codebase-architecture.md) (the survey that finds candidates) |
| You want the design argued with, not just named | [grilling](https://github.com/rahularoratech/itech-skills/blob/main/docs/productivity/grilling.md) |
| There's a concrete behaviour to build and you want tests that survive a refactor | [tdd](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/tdd.md) |
