...
- For designing one module you have already chosen, use [codebase-design](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/codebase-design.md): that is the bench, this is the survey that finds what to put on it.
- For a whole effort too big to hold in one session, use [wayfinder](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/wayfinder.md).
- For "this specific thing is broken," use [diagnosing-bugs](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/diagnosing-bugs.md). It hands back here when the real finding is that there is no good seam to lock the bug down.
...
Picking a candidate starts a [grilling](https://github.com/rahularoratech/itech-skills/blob/main/docs/productivity/grilling.md) session over it: constraints, what sits behind the seam, which tests survive, what the deepened interface should look like. The output of that session is a decision, not a diff. From there the normal flow applies: take the decision into [to-spec](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/to-spec.md), then [to-tickets](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/to-tickets.md), then [implement](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/implement.md).
...
`improve-codebase-architecture` is **periodic maintenance**: run it every few days, outside any chain, to queue up work rather than to do it. Its neighbours are [codebase-design](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/codebase-design.md), which owns the depth-and-seam vocabulary every candidate is written in, [grilling](https://github.com/rahularoratech/itech-skills/blob/main/docs/productivity/grilling.md), which walks the decision tree once you have chosen a candidate, and [domain-modeling](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/domain-modeling.md), which keeps `CONTEXT.md` and the ADRs current as the decision settles. What it produces is an idea, which re-enters the main build flow at [grill-with-docs](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/grill-with-docs.md) or [to-spec](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/to-spec.md). For which skill fits a situation, [ask-itech-skills](https://github.com/rahularoratech/itech-skills/blob/main/docs/engineering/ask-itech-skills.md) is the router over the whole set.
