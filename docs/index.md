...
- [Command reference](commands.md) lists every command, its invocation mode, and its guide.
- [Engineering](engineering/ask-itech-skills.md) and [productivity](productivity/grill-me.md) guides explain when each skill fits.

## Choose where to start

| Situation | Start with |
| --- | --- |
| You have an idea and want to shape it in the current repository | [grill-with-docs](engineering/grill-with-docs.md) |
