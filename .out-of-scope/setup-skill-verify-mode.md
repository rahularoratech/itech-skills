# Verify/Check Mode for `setup-itech-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-itech-skills`.
...
- #106: Feature request: verify/check mode for setup-itech-skills
